 		...
 		<div class="myspan">
			 	...
			 	<div class="myuser-right">
			 		<form action="updatauser" method="post" class="form-horizontal" id="myform">
						...
						<div class="control-group">
							<label class="control-label">Giới tinhs：</label>
						    <div class="controls">
						      <label class="radio inline">
						        <input type="radio" value="Nam" name="sex"
						        <c:if test="${ user.sex == 'Nam' }"> checked="checked"</c:if>>Nam
						      </label>
						      <label class="radio inline">
						        <input type="radio" value="Nu" name="sex"
						        <c:if test="${ user.sex == 'Nu' }"> checked="checked"</c:if>>Nữ
						      </label>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							<div class="controls  right-ci">
								<input type="submit" value="Xác nhận" class="btn btn-success btn-large btn-block"/>
							</div>
						</div>
					</form>
			 	</div>
