...
<body>
 	...
 	<div class="row">
 		<div class="myspan">
	 		...
	 		<div class="succeed">
	 			<h3 style="color:#7ABD54;">Đơn hàng của bạn đã được gửi thành công！</h3>
	 			<h4>Trang web sẽ chuyển hướng sau <span id="tiao">3</span>
	 			<a href="admin/users/orderform.jsp">giây</a></h4>
	 		</div>
